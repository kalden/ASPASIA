...
/**
 * Takes output from an SBML Solver and uses this to create a new SBML Model.
...
public class SBMLFileFromSolverOutput
{
	...
	System.out.println("Finished. Check " + this.paramFileOutputFolder + " for new file "
	...
	try
	{
	    ...
	    // Header:
	    System.out.println(this.sbmlRunResultsFile);
